...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            Already have an account for this Email address.</label>';
        }else{
            //data for chat
            ...
            $database->query("insert user(unique_id, img, username, email, pass, status)VALUES('$unique_id', '$uploaded_image', '$uname', '$mail', '$crypt', '$status')");
