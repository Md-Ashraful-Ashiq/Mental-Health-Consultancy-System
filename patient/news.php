    ...
    <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-news menu-active menu-icon-news-active">
                    <a href="news.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Events</p></a></div>
                </td>
            </tr> 
            <tr class="menu-row">
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr >
                ...
                <td>
                    <p style="font-size: 23px;padding-left:12px;font-weight: 600; color: black">Events</p>
                    <p style="font-size: 15px;padding-left:12px;font-weight: 600; color: black">You can check out all the important mental health events and seminars around you here.</p>
