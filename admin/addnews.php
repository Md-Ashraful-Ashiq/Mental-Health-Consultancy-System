...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($database, "DELETE FROM news WHERE id = $id");
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-news menu-active menu-icon-news-active">
                        <a href="addnews.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Events</p></a></div>
                    </td>
                </tr> 
                <tr class="menu-row">
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr >
                ...
                <td>
                    <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Add Upcoming Events</p>                          
                </td>  
            </tr>
...
<div class="admin-product-form-container">
   ...
   <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
      ...
      <input type="text" placeholder="Event details" name="product_price" class="box">
